...
// Define the content structure for the news items
class StyledContent {
  final String text;
...
class NewsDetailScreen extends StatefulWidget {
  ...
  NewsDetailScreen({required this.newsItem, required this.disease});
  ...
  Future<void> _launchUrl(String url) async {
    ...
    try {
      ...
      if (canLaunchUrlResult) {
        ...
        _showErrorDialog(
            'Unable to open the URL. Please check the URL and try again.');
      }
    } catch (e) {
      _showErrorDialog('An error occurred while trying to open the URL: $e');
    }
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // onPressed: () {
            // String url =
            //   'https://www.google.com/search?q=${Uri.encodeComponent(widget.newsItem.title)}';
            // print('Launching URL: $url'); // Debug print
            //_launchUrl(url);
            //},
            // child: Text('Learn More About ${widget.newsItem.title}'),
            //),
          ],
        ),
      ),
